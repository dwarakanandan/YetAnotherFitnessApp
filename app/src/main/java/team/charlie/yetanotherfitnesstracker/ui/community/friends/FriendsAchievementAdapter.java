...
public class FriendsAchievementAdapter extends RecyclerView.Adapter<FriendsAchievementAdapter.ViewHolder> {
    ...
    public FriendsAchievementAdapter(List<AchievementUnlocked> listImage) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View listItem = inflater.inflate(R.layout.activity_friends_achievements_list_items,parent,false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.imageButton.setImageResource(R.drawable.ic_info);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            this.imageView = itemView.findViewById(R.id.achievementFriendsImage);
            this.imageButton = itemView.findViewById(R.id.achievementFriendsButton);
        }
    }
